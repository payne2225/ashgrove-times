...
- 2026-08-30T11:04:19Z · 2026-08-30 · post_discord: --not-before 07:00 already passed (07:04); posting now
- 2026-08-30 — **The digest posted at 7:04:19, four minutes late, because the background post process died during the hold.** Launched at 6:01 a.m. with `nohup ... &` per the standing rule, confirmed alive at 6:01, held with `--not-before 07:00` — and was gone by 7:03 with a zero-byte log and no index record. Nothing was sent (no message id, idempotency gate clean), so this is the 2026-08-13/14 failure in a new costume: in this remote sandbox a nohup'd background process does NOT reliably survive once the session goes idle between turns — the container reclaims it. The 7:02 self-scheduled verification wake caught it and re-ran the post in the foreground (hold already past, posted immediately). **Fix for tomorrow: do not trust a backgrounded hold. Schedule the wake-up for ~6:58 ET and run the post in the FOREGROUND from that wake, when the hold is only a minute or two, or verify at 6:59 rather than 7:02.**
- 2026-09-07 — **`fetch_fishing.py` reports a "24h ago" value and a trend against a 48-hour window.** The Williams River crested at 208 cfs at 11:30 p.m. Saturday and read 166 at 5:45 a.m. Sunday; this morning's `out/fishing.json` said 103 cfs, `discharge_cfs_24h_ago: 48.8`, `discharge_cfs_trend: "rising"`. The 48.8 is the first reading in the fetcher's `period=P2D` request (Saturday 5:45 a.m.), so the flag compares against two days ago and calls a river that has halved since Sunday morning "rising." Same artifact in yesterday's "53.7 a day earlier." Not edited by the routine (the playbook forbids it); the water line printed the file's 103 cfs and 1.65 ft and described the recession in prose with no unsourced number. Fix: pick the reading nearest 24 hours before the latest, not the window's first.
- 2026-09-09 — **Yesterday's Sports & Sportsman (No. 25, 2026-09-08) printed "Waning crescent at 13%, so neap tides and a gentle inlet" in the Topsail block. That was wrong.** USNO puts the new moon at 03:27 UTC Sept. 11 (11:27 p.m. ET Thursday, Sept. 10); a 13% waning crescent two days before new is spring tides BUILDING, not neap. Neap tides go with the quarter moons, and the illumination figure alone does not say which side of new the moon is on. The page was not re-rendered (the fact was a day old by the time it was caught); today's block says springs building and cites USNO. Rule for tomorrow: read the moon's AGE or the next-phase date, not the illumination, before writing "neap" or "spring."
- 2026-09-13 — **`fetch_fishing.py`'s 48-hour "24h ago" comparison flipped the DIRECTION of the Huntington read, not just the figure.** At 5:37 a.m. the Ohio at Huntington read 27.69 ft with `stage_ft_24h_ago: 28.55` (Friday 7 a.m.) and `stage_ft_trend: "falling"`, and the fetcher's `read` string said "27.7 ft and falling — up and pushing." The USGS trace read 26.59 at 5 a.m. Saturday and rose 1.10 ft from 7 p.m. Saturday to 5 a.m. Sunday, still climbing about a tenth an hour, with the NWS forecast a 28.7 ft crest Monday afternoon. Sports & Sportsman No. 30 printed `reading` "27.69 feet, rising." and shortened the fetcher's `read` to drop "and falling" (the numbers are the file's; the direction word is the trace's, and the entry's note says so). Same artifact on the Williams ("rising" against Friday for a river that read 54.9/1.34 both mornings) and Point Pleasant ("steady" against Friday for a pool up 0.96 ft). Logged 2026-09-07 as a comparison-figure bug; today it would have printed a falling river that was rising a foot. Fix stands: compare against the reading nearest 24 hours before the latest, not the window's first, and derive the trend from that.
- 2026-09-16 — **Stripped URL.** The validator stripped the CBS Sports box-score link on Sports & Sportsman No. 33's Braves-Cubs brief (`MLB_20260915_ATL@CHC`) as a 404; the brief keeps its `source`. The Leagues desk reported reading that box score, so the address it read and the address it wrote differed, or CBS moved the page between 5:44 and 5:47 a.m. Nothing else degraded: USGS 503 on both Ohio gauges at the 5:32 fetch cleared on the 5:33 re-run before anything was written.
- 2026-09-17 — **`fetch_fishing.py`'s 48-hour "24h ago" comparison flipped the Point Pleasant direction.** At 5:32 a.m. the Ohio at Point Pleasant read 24.92 ft with `stage_ft_24h_ago: 25.79` (Tuesday 5:45 a.m., the first point of the two-day window) and `stage_ft_trend: "falling"`. The USGS trace shows the pool bottomed at 24.38 ft at 8 a.m. Wednesday, climbed to 25.30 at 5:30 p.m. and eased 0.38 overnight — up 0.30 in the true 24 hours. Sports & Sportsman No. 34 printed the file's numbers and the fetcher's `read` as written, and described the direction from the trace in `working` and `note`, saying which is which. Third logged instance (09-07, 09-13, today). Fix stands: compare against the reading nearest 24 hours before the latest.
- 2026-09-18 — **Correction, sumo.** Sports & Sportsman No. 34 (2026-09-17) named the maegashira who pushed out Kotozakura on Day 5 "Mitoumi." The wrestler is 美ノ海, **Churanoumi**, per the Japan Sumo Association's English leaders page opened this morning; the desk read the kanji wrong off a Yahoo Japan copy. Today's No. 35 uses Churanoumi throughout; yesterday's page was not re-rendered. Rule for tomorrow: check a shikona against the JSA English page or Sportsnavi's romanization before printing a name that has not run before.
- 2026-09-18 — **Near miss, notebook rerun.** The WV desk filed the Red Oak Fire Tower item as today's cabin hotspot line; it was the 09-15 cabin line verbatim in substance. Caught at the editor's dedupe pass against the last three editions and swapped for the Webster County Fair item before validation. Nothing shipped wrong; logged because the desk prompt listed only the two prior days' slugs and the rerun was three days back — tomorrow's desk brief should carry all three prior editions' notebook items, not two.
- 2026-09-20 — **Two-day hole in the record, found at this morning's idempotency check.** `editions/index.json` has no record for 2026-09-18 and nothing for 2026-09-19. Edition No. 45 and Sports & Sportsman No. 35 were validated, rendered and pushed on 09-18 at 5:47 a.m. ET (f30a750) with the ledger's pre-post entry (a671431); the 6:50 a.m. `send_later` wake armed to run the digest fired (the trigger's last_run reads SUCCEEDED at 10:51 UTC), and no "Posted No. 45" commit, index record or ledger post-line followed, and the weather-page routine made no commit that day either. The 09-19 routine did not run at all: no edition files, no commits, no trigger firing visible from here. Whether the 09-18 digest reached the channel cannot be verified from the repo; the 09-19 paper was never written. Today's kicker carries the gap in one line ("No edition ran Saturday, and Friday's digest went unrecorded"), nothing is backfilled, and today's numbers were computed from the edition files (No. 46, S&S No. 36) rather than the index, which would have reissued No. 45. For Nate: check the channel for a Sept. 18 digest, and the routine's run history for the 19th.
- 2026-09-20 — **Result-verb gate, six briefs, no wrong direction shipped.** The Sports & Sportsman validator refused the Crew brief and five Around the Leagues briefs on the first pass, each with a correct `result` and a correct headline: the reader takes the FIRST verb in its list found anywhere in headline+summary and the team whose FIRST mention is latest before it, so "Brighton beats Arsenal 3-0 ... Brighton and Hove Albion beat Arsenal 3-0 at the Amex" resolves the summary's "beat" with Arsenal (first mentioned in the headline, after "Brighton") as subject and reads it as a Brighton loss. Rewritten to one win verb per brief with the loser named after it; a note for the desk prompt, not a validator change.

- 2026-09-21 — **`fetch_fishing.py`'s 48-hour "24h ago" comparison again on all three USGS gauges** (fourth logged instance: 09-07, 09-13, 09-17, today). Williams `discharge_cfs_24h_ago: 58.8` is the 5:45 a.m. Saturday reading, 47 hours before the fetch; the true 24-hour mark was 90.4 cfs. The flag ("rising") happens to match the 24-hour change, but the river crested at 1,560 cfs at 4 p.m. Sunday and had been receding for 13 hours at the fetch. Sports & Sportsman No. 37 printed the file's numbers and read string as written and described both directions in `working` and `note`, saying which is which. Fix stands: compare against the reading nearest 24 hours before the latest.
- 2026-09-21 — **Sportsman index still stops at No. 11; edition numbers computed from the edition files** (Times No. 47 from `editions/index.json`, which is current; S&S No. 37 from `editions/sportsman/`). Not degraded, logged so the numbering source is on the record.

- 2026-09-22 — **USGS returned 503 on all three gauges at the 5:33 fishing fetch**; a background retry loop cleared it on the second try at 5:35 (4 waters, 0 errors) before anything was written. Not degraded; logged because it is the second morning in a week (09-16, today) the first fetch failed.
- 2026-09-22 — **`fetch_fishing.py`'s 48-hour "24h ago" comparison, fifth logged instance (09-07, 09-13, 09-17, 09-21, today), and this time the Williams flag is wrong on both the day and the morning.** The file says 582 cfs, `discharge_cfs_24h_ago: 97.3`, `discharge_cfs_trend: "rising"`; 97.3 is the 5:45 a.m. Sunday reading, 47.5 hours back. The true 24-hour mark was 750 cfs (down 168) and the trace has been receding since a 1,560-cfs crest at 4 p.m. Sunday. Sports & Sportsman No. 38 printed the file's numbers and `read` string as written and described the recession in `working` and `note`, saying which is which. Fix stands: compare against the reading nearest 24 hours before the latest.
- 2026-09-22 — **Three desk scratch files (`art_downs.txt`, `art_kudus.txt`, `art_mex.txt`) were committed to the repo root by `git add -A` in 3bb4ad1** — curl output a research desk wrote to the working directory instead of the session scratchpad. Removed two minutes later in 7af0271; nothing rendered from them and nothing in them was sensitive. Rule for tomorrow: every desk prompt names the scratchpad as the only place to write, and the editor runs `git status` before `git add -A`.
- 2026-09-22 — Sportsman index still stops at No. 11; edition numbers computed from the edition files (Times No. 48 from `editions/index.json`, which is current; S&S No. 38 from `editions/sportsman/`).

- 2026-09-23 — **Stat strip ran empty: Yahoo's chart had no Tuesday close.** At 5:43, 5:48 and 5:58 a.m. `fetch_stats.py` returned S&P 7,764.70, Dow 52,048.83 and Nasdaq 27,122.09 with `as_of: 2026-09-21` — Monday's close, the figures No. 48 had already printed on Tuesday. Yahoo's v8 chart carries a Sept. 22 bar with a null close and a `regularMarketTime` stuck at 3:09 p.m. ET Tuesday, so the fetcher's last non-null bar was Monday's and inside its four-trading-day tolerance. Printing a day-stale close under Wednesday's masthead as "before the opening bell" would read as Tuesday's, so No. 49 ran `stat_strip: []` (Bitcoin alone, dated today, was not worth a one-figure band). Not a fabrication; logged as a degraded path. If Yahoo is still stuck on Thursday, the fetcher needs a second source or a staleness cap of one trading day on weekdays.
- 2026-09-23 — **`fetch_fishing.py`'s 48-hour "24h ago" comparison, sixth logged instance (09-07, 09-13, 09-17, 09-21, 09-22, today), and this morning every flag is wrong on the direction at the fetch.** Williams: 1450.0 cfs flagged "rising" against 755.0 (Monday ~6 a.m.); the trace has a new crest of 2,610 cfs at 9:30 p.m. Tuesday and eight hours of recession since. Point Pleasant: 26.09 ft flagged "steady" against 26.21; the true 24-hour change is down 2.70 ft from 28.79. Huntington: 31.94 ft flagged "rising" against 28.58; it crested at 33.97 ft (USGS) / 34.05 (NWPS) at 2:15 p.m. Tuesday, 1.55 ft under the 35.6 forecast No. 38 printed, and is down 1.42 on the day. Sports & Sportsman No. 39 printed the file's numbers and `read` strings as written and described the traces' directions in `working` and `note`, saying which is which. Fix stands: compare against the reading nearest 24 hours before the latest.
- 2026-09-23 — Sportsman index still stops at No. 11; edition numbers computed from the edition files (Times No. 49 from `editions/index.json`, which is current; S&S No. 39 from `editions/sportsman/`).

- 2026-09-24 — **USGS returned 503 on the Williams and Point Pleasant gauges at the 5:43 fishing fetch**; a 20-second retry loop cleared it on the second try at 5:45 (4 waters, 0 errors) before anything was written. Not degraded; logged because it is the third morning in nine (09-16, 09-22, today) the first fetch failed.
- 2026-09-24 — **`fetch_fishing.py`'s 48-hour "24h ago" comparison, seventh logged instance (09-07, 09-13, 09-17, 09-21, 09-22, 09-23, today).** Williams: 755.0 cfs flagged "rising" against 572.0 (6 a.m. Tuesday, the window's first point); the true 24-hour mark was 1,450 cfs (down 695), and the flag is right only on the last two and a quarter hours, up 34 cfs from a 721-cfs low at 3 a.m. Point Pleasant: 25.98 ft flagged "falling" against 28.84 (6 a.m. Tuesday, near the crest); the pool bottomed at 25.35 Wednesday evening and has risen 0.63 ft since. Huntington: "falling" against 33.51 — right both ways by accident of the window starting near the crest. Sports & Sportsman No. 40 printed the file's numbers and `read` strings as written and described the traces' directions in `working` and `note`, saying which is which. Fix stands: compare against the reading nearest 24 hours before the latest.
- 2026-09-24 — **Nicholas-Webster ran no regional line for a fifth consecutive morning** (09-20 through today). WOAY, WCHS, Register-Herald, WVVA, lootpress, the Nicholas Chronicle (still May), nicholascountywv.org, summersvillewv.org, Nicholas County Schools and the DOH were searched; WVNS and WOWK county pages 403. Thin, not padded; logged because five mornings is a sourcing problem, not a quiet county.
- 2026-09-24 — Sportsman index still stops at No. 11; edition numbers computed from the edition files (Times No. 50 from `editions/index.json`, which is current; S&S No. 40 from `editions/sportsman/`).

- 2026-09-25 — **USGS returned 503 on all three gauges at the 5:44 fishing fetch, and on two or three of them across four 20-second retries**; a background retry loop cleared it on its first pass at 5:46 (4 waters, 0 errors) before anything was written. Not degraded; logged because it is the fourth morning in ten (09-16, 09-22, 09-24, today) the first fetch failed, and the first time the retries took more than one pass. Yahoo also 429'd the Nasdaq on the first `fetch_stats.py` at 5:44; a rerun at 5:50 returned all four entries at Thursday's close, and the strip ran four.
- 2026-09-25 — **`fetch_fishing.py`'s 48-hour "24h ago" comparison, eighth logged instance (09-07, 09-13, 09-17, 09-21, 09-22, 09-23, 09-24, today).** Williams: 950.0 cfs flagged "falling" against 1,410 (6 a.m. Wednesday, the window's first point); the trace's true 24-hour mark was 755 cfs, so the river is UP 195 on the day after a second crest of 1,660 cfs at 1:15 p.m. Thursday. Huntington: 28.73 was the true 24-hour mark and the gauge is up 1.46 ft and rising, flagged "falling". Point Pleasant's flag happened to be right. Sports & Sportsman No. 41 printed the file's numbers and read strings as written and described the traces' directions in `working` and `note`, saying which is which. Fix stands: compare against the reading nearest 24 hours before the latest.
- 2026-09-25 — **Nicholas-Webster ran no regional line for a sixth consecutive morning** (09-20 through today). The Webster Echo (ledes via curl), WOAY front and tag, WCHS search, Register-Herald, WVVA, lootpress, the Nicholas Chronicle (still May), nicholascountywv.org agendas, summersvillewv.org, both school districts, WVDOH releases and the sheriff's Facebook page were searched; WBOY's Webster page and WOWK 403. Nothing dated within 48 hours. Thin, not padded; the Echo's Sept. 21 batch supplied the cabin hotspot line instead. The Echo posts a weekly batch on Mondays, so Monday is the next real chance.
- 2026-09-25 — Sportsman index still stops at No. 11; edition numbers computed from the edition files (Times No. 51 from `editions/index.json`, which is current; S&S No. 41 from `editions/sportsman/`).

- 2026-09-26 — **USGS returned 503 on the Williams gauge at the 5:44 fishing fetch** (Point Pleasant and Huntington answered); a background 30-second retry loop cleared it on its first pass at 5:44:48 (4 waters, 0 errors) before anything was written. Not degraded; logged because it is the fifth morning in eleven (09-16, 09-22, 09-24, 09-25, today) the first fetch failed. CoinGecko also 429'd Bitcoin on the first `fetch_stats.py` at 5:44; a rerun at 5:45 returned all four entries at Friday's close, and the strip ran four.
- 2026-09-26 — **Nicholas-Webster ran no regional line for a seventh consecutive morning** (09-20 through today). The Webster Echo /category/news/ (latest post Sept. 22), WOAY tag/nicholas-county (no county items), WCHS site search, lootpress (latest Nicholas item Aug. 18), the Register-Herald front and the Hinton News front were searched; nothing dated within 48 hours. Thin, not padded; the Echo's Sept. 21 batch supplied the cabin hotspot line (Camden-on-Gauley water works) instead. Saturday: the Echo's next weekly batch is Monday.
- 2026-09-26 — Sportsman index still stops at No. 11; edition numbers computed from the edition files (Times No. 52 from `editions/index.json`, which is current; S&S No. 42 from `editions/sportsman/`).
- 2026-09-26 — **`fetch_fishing.py`'s 48-hour "24h ago" comparison, ninth logged instance (09-07, 09-13, 09-17, 09-21 through 09-25, today).** All three comparison points are again the window's first point, 5:45 a.m. Thursday. Williams: 523.0 cfs flagged "falling" against 767.0; the true 24-hour mark was 950 (down 427), so the flag is right by accident of the window. Point Pleasant: 25.37 flagged "falling" against 26.02; true mark 26.61 (down 1.24), right. **Huntington: 29.82 flagged "rising" against 28.78; the gauge crested at 30.79 ft at 2:45 p.m. Friday and is down 0.37 on the day from 30.19 — the flag is wrong on both counts.** Sports & Sportsman No. 42 printed the file's numbers and read strings as written and described the traces' directions in `working` and `note`, saying which is which. Fix stands: compare against the reading nearest 24 hours before the latest.
