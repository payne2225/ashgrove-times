...
| **2027-03-14** | **Switch the routine's cron back to `0 10 * * *`.** EDT resumes at 2 AM that Sunday; leaving the winter cron installed wakes the routine at 7:15 ET, which is already past the delivery target and *after* the forecast the paper points at | **OPEN** |
