...
LINE = "H: 95° / L: 73° · feels 103° at 2–3 PM · RH 35% · rain 2% · AQI 97"
...
def test_prefixed_and_celsius_and_missing_segments():
    row = r._wx_stats_row("**Apple Grove** H: 21°C / L: 12°C · feels 19°C at 2 PM · RH 80% · rain 84%")
    assert row["place"] == "Apple Grove" and row["high"] == "21°C" and row["aqi"] == ""
    assert r._wx_stats_row("H: — / L: 67° · RH 50%")["high"] == "—"
...
def test_a_stack_gets_one_row_per_place():
    body = ("### 📍 Apple Grove — Nate & Ian\n### 📍 Huntington — Trav\n"
            "**Apple Grove** H: 95° / L: 73° · feels 103° at 2–3 PM · RH 35% · rain 2% · AQI 97\n"
            "**Huntington** H: 98° / L: 74° · feels 106° at 2 PM · RH 33% · rain 2% · AQI 88\n"
